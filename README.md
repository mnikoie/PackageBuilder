...
**قدمِ ۷ از ۸ تمام شد.** ابزار حالا واقعاً **کار می‌کند**: یک پوشهٔ خالی
می‌گیرد، تکنولوژی نصب می‌کند، تصمیم را ثبت می‌کند، و می‌تواند پسش بگیرد.

آزمایشِ زندهٔ کامل: `apply postgres` روی یک پوشهٔ نو → کانتینر بالا آمد، پورتِ
آزاد خودکار انتخاب شد (چون ۵۴۳۲ مشغول بود)، و `pg_isready` از میزبان جواب داد.
بعد `revert` → خوابید و همه‌جا پاک شد، ولی تصمیمِ دیگر دست‌نخورده ماند.

قدمِ ۸ (رابطِ کاربریِ کامل + تستِ Playwright) بعدی است.
