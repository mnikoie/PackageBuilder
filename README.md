...
**قدمِ ۴ از ۸ تمام شد.** ساختِ پروژه، تشخیصِ وضعیتِ واقعی، و نمایشش در مرورگر.
قدمِ ۵ (ترمینالِ واقعیِ PowerShell) بعدی است.
...
# همان گزارش، در مرورگر (فقط-خواندنی، فقط روی 127.0.0.1)
