...
**قدمِ ۵ از ۸ تمام شد.** ساختِ پروژه، تشخیصِ وضعیتِ واقعی، نمایشش در مرورگر، و
یک PowerShellِ واقعیِ تعبیه‌شده که همهٔ فرمان‌ها داخلش دیده می‌شوند.
قدمِ ۶ (رجیستریِ تکنولوژی‌ها) بعدی است.
